            ...
            <?php foreach ($staff as $staff) { ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="person-view">
                        <div class="row">
                            <img src="<?php echo base_url(); ?>images/staff/profile/<?php echo $staff->profileimage; ?>" alt="Staff - <?php echo $staff->fname . " " . $staff->lname; ?>"></img>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <?php echo coop_map_embed($staff->city . ', ' . $staff->country, '', 280, FALSE); ?>
                            </div> 
                        </div>
                    </div>
