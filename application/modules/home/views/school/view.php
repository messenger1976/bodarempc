            ...
            <?php foreach ($school as $school) { ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="person-view">
                        <div class="row">
                            <img src="<?php echo base_url(); ?>images/sundayschool/profile/<?php echo $school->profileimage; ?>" alt="School - <?php echo $school->fname . " " . $school->lname; ?>"></img>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <iframe
                                    ...
                                    src="https://www.google.com/maps?q=<?php echo rawurlencode($school->city . ', ' . $school->country); ?>&output=embed">
                                </iframe>
                            </div> 
                        </div>
                    </div>
