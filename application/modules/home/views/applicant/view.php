            ...
            <?php foreach ($applicant as $applicant) { ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="person-view">
                        <div class="row">
                            <img src="<?php echo base_url(); ?>images/seminar/profile/<?php echo $applicant->profileimage; ?>" alt="Applicant - <?php echo $applicant->fname . " " . $applicant->lname; ?>"></img>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <iframe
                                    ...
                                    src="https://www.google.com/maps?q=<?php echo rawurlencode($applicant->city . ', ' . $applicant->country); ?>&output=embed">
                                </iframe>
                            </div> 
                        </div>
                    </div>
