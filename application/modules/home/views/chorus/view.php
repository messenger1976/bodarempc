            ...
            <?php foreach ($chorus as $chorus) { ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="person-view">
                        <div class="row">
                            <img src="<?php echo base_url(); ?>images/chorus/profile/<?php echo $chorus->profileimage; ?>" alt="Chorus - <?php echo $chorus->fname . " " . $chorus->lname; ?>"></img>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <?php echo coop_map_embed($chorus->city . ', ' . $chorus->country, '', 280, FALSE); ?>
                            </div> 
                        </div>
                    </div>
