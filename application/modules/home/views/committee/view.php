            ...
            <?php foreach ($committee as $committee) { ?>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="person-view">
                        <div class="row">
                            <img src="<?php echo base_url(); ?>images/committee/profile/<?php echo $committee->profileimage; ?>" alt="Committee Member - <?php echo $committee->fname . " " . $committee->lname; ?>"></img>
                        ...
                        <div class="row">    
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <?php echo coop_map_embed($committee->city . ', ' . $committee->country, '', 280, FALSE); ?>
                            </div> 
                        </div>
                    </div>
