        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <p class="fw-medium text-uppercase text-primary mb-2">Board of Directors</p>
                    <h1 class="display-5 mb-4">Our Leadership Team</h1>
                    <p class="mb-4">The Board of Directors of the Bohol DAR Employee & Community Multi-Purpose Cooperative is composed of dedicated leaders committed to the organization's mission and the welfare of its members. They provide strategic guidance and oversight to ensure the cooperative remains strong and true to its values.</p>

                    <p class="mb-4">Our board members bring diverse expertise and a shared commitment to serving the cooperative's members with integrity, transparency, and excellence.</p>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-12 text-center wow fadeIn" data-wow-delay="0.1s">
                    <h2 class="display-5 mb-5">Board Members</h2>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="card card-profile" style="padding: 10px;">
                            <div class="card-avatar" style="text-align: center;">
                                <img class="img" src="<?php echo base_url(); ?>images/<?php if($member->profileimage){ echo "board_of_directors/profile/" . $member->profileimage; }else{ echo "avatar.png"; } ?>" alt="<?php echo $member->fname . " " . $member->lname; ?>">
                            </div>
                            <div class="content text-center">
                                ...
                                <div class="action-btn">
                                    <a href="<?php echo base_url(); ?>home/board_of_directors/view/<?php echo $member->board_of_directorsid; ?>" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i> View Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
