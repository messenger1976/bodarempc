                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($row->sermonbanner) { ?>
                                                <img class="committee img" src="<?php echo base_url(); ?>images/sermon/feature/<?php echo $row->sermonbanner; ?>">
                                            <?php } else { ?>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url(); ?>dashboard/sermon/view/<?php echo $row->sermonid; ?>" class="btn btn-primary"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
