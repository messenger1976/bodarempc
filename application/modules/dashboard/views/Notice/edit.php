                    ...
                    <div class="card-content">
                        <form id="updateNoticeForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/notice/update" method="post" enctype="multipart/form-data">
                            <?php foreach ($individual as $row): ?>
                                ...
                                <button id="updateNoticeSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">bookmark</i> <?php echo $this->lang->line('dash_addnotice_panel_title'); ?></button>
