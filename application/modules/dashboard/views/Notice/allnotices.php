                                ...
                                foreach ($notice as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>dashboard/notice/view/<?php echo $row->noticeid; ?>" class="btn btn-primary"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
