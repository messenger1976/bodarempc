            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_addcooperative_officers_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">

                        <form id="addCooperative_officersForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/cooperative_officers/addnewcooperative_officers" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <button id="addCooperative_officersSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_addcooperative_officers_panel_title'); ?></button>
