            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_updatecooperative_officers_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">
                        <?php foreach ($individual as $row): ?>
                            <form id="updateCooperative_officersForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/cooperative_officers/update" method="post" enctype="multipart/form-data">
                                <div class="row">
                                ...
                                <input type="hidden" id="cooperative_officersid" name="cooperative_officersid" value="<?php echo $row->cooperative_officersid; ?>">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <button id="updateCooperative_officersSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updatecooperative_officers_panel_title'); ?></button>
