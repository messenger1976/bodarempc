                ...
                <div class="col-md-offset-1 col-md-10">
                    <div class="card card-profile">
                        <div class="card-avatar">						
                            <img class="img" src="<?php echo base_url(); ?>images/<?php if($row->profileimage){ echo "committee/profile/" . $row->profileimage; }else{ echo "avatar.png"; } ?>" alt="<?php echo $row->fname; ?>">
