            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">bookmark</i> <?php echo $this->lang->line('dash_allprayer_panel_title'); ?> ( <?php
                            $this->db->from('prayer');
                                ...
                                foreach ($prayer as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            ?></td>
                                        <td>
                                            <a href="<?php echo base_url(); ?>dashboard/prayer/view/<?php echo $row->prayerid; ?>" class="btn btn-primary"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
