...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192" href="<?php echo base_url(); ?>images/favicon.png">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="index.html">
                        ...
                        <span class="smini-hide font-size-h5 tracking-wider">
                            TAUDELTA<span class="font-w400">PHI</span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        ...
                        ?>" href="<?php echo base_url('dashboard'); ?>">
                                    ...
                                    <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_dash'); ?></span>
                                </a>
                            </li>
                            ...
                            ?>">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    ...
                                    <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_website'); ?></span>
                                </a>
                                <ul class="nav-main-submenu <?php
                                ...
                                ?>">
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/website/header'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_basic'); ?></span>
                                        </a>
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/menu'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_menus'); ?></span>
                                        </a>
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/website/slider'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_slider'); ?></span>
                                        </a>
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/website/gallery'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_gallery'); ?></span>
                                        </a>
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/section'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_section'); ?></span>
                                        </a>
                                    ...
                                    ?>" href="<?php echo base_url('dashboard/page'); ?>">
                                            <i class="nav-main-link-icon si si-bag"></i>
                                            <span class="nav-main-link-name"><?php echo $this->lang->line('dash_menu_page'); ?></span>
                                        </a>
