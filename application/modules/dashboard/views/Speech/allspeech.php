            ...
            <div class="col-md-4">
                <div class="allspeechs card card-profile">
                    <div class="card-avatar">							
                        <img class="committee img" src="<?php echo base_url(); ?>images/<?php if($row->profileimage){ echo "speech/profile/" . $row->profileimage; }else{ echo "avatar.png"; } ?>">
                    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="col-md-12 action-btn">
                            <a href="<?php echo base_url(); ?>dashboard/speech/view/<?php echo $row->speechid; ?>" class="btn btn-primary btn-round"><i class="material-icons">call_made</i> <?php echo $this->lang->line('dash_gpanel_view'); ?></a>
