            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_addboard_of_directors_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">

                        <form id="addBoard_of_directorsForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/board_of_directors/addnewboard_of_directors" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <button id="addBoard_of_directorsSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_addboard_of_directors_panel_title'); ?></button>
