            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="purple">
                        <h4 class="title"><i class="material-icons">people</i> <?php echo $this->lang->line('dash_updateboard_of_directors_panel_title'); ?></h4>
                        <p class="category">(*) <?php echo $this->lang->line('dash_gpanel_mfar'); ?></p>
                    </div>
                    <div class="card-content">
                        <?php foreach ($individual as $row): ?>
                            <form id="updateBoard_of_directorsForm" class="form-horizontal" action="<?php echo base_url(); ?>dashboard/board_of_directors/update" method="post" enctype="multipart/form-data">
                                <div class="row">
                                ...
                                <input type="hidden" id="board_of_directorsid" name="board_of_directorsid" value="<?php echo $row->board_of_directorsid; ?>">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <button id="updateBoard_of_directorsSubmit" type="submit" class="btn btn-primary pull-right"><i class="material-icons">person_add</i> <?php echo $this->lang->line('dash_updateboard_of_directors_panel_title'); ?></button>
