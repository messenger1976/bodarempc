...
class Cooperative_officers extends MX_Controller {
    ...
    /*     * ************************** */
    /*     * *** Index Page Of Cooperative_officers **** */
    /*     * ************************** */
    ...
    public function index() {
        ...
        $this->load->view('Cooperative_officers/addcooperative_officers', $data);
        $this->load->view('Dashboard/footer');
    }

    /*     * ************************** */
    /*     * ******* Add Cooperative_officers ******* */
    /*     * ************************** */

    public function addcooperative_officers() {
        $data['family'] = $this->getFamily();
        $data['department'] = $this->getDepartment();
        $this->load->view('Dashboard/header');
        $this->load->view('Cooperative_officers/addcooperative_officers', $data);
    ...
    /*     * ************************** */
    /*     * ******* Adding New Cooperative_officers ******* */
    /*     * ************************** */

    public function addnewcooperative_officers() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            /*             * ****************************** */
            $imagePath = realpath(APPPATH . '../images/cooperative_officers');
            ...
            $inserted = $this->db->insert('cooperative_officers', $data);
            if ($inserted == TRUE) {
    ...
    /*     * ************************** */
    /*     * ******* All Cooperative_officers ******* */
    /*     * ************************** */

    public function allCooperative_officers() {

        $baselink = "cooperative_officers/allCooperative_officers";
    ...
    /*     * ************************** */
    /*     * ******* View Individual Cooperative_officers ******* */
    /*     * ************************** */
    ...
    /*     * ************************** */
    /*     * *** Edit Cooperative_officers Profile **** */
    /*     * ************************** */
    ...
    public function edit() {
        ...
        $data['department'] = $this->getDepartment();
        $this->load->view('Dashboard/header');
        $this->load->view('Cooperative_officers/edit', $data);
        $this->load->view('Dashboard/footer');
    }

    /*     * ************************** */
    /*     * *** Update Cooperative_officers Profile **** */
    /*     * ************************** */
    ...
    public function update() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $cooperative_officersid = $this->input->post('cooperative_officersid');
            $data['fname'] = $this->input->post('fname');
            $data['lname'] = $this->input->post('lname');
            $data['phone'] = $this->input->post('phone');
            $data['email'] = $this->input->post('email');
            ...
            $this->db->where('cooperative_officersid', $cooperative_officersid);
            $updated = $this->db->update('cooperative_officers', $data);
            if ($updated == TRUE) {
    ...
    /*     * ************************** */
    /*     * *** Delete Cooperative_officers Profile **** */
    /*     * ************************** */

    public function delete($cooperative_officersid) {
        $this->db->where('cooperative_officersid', $cooperative_officersid);
        $this->db->delete('cooperative_officers');
        redirect('dashboard/cooperative_officers/allCooperative_officers', 'refresh');
    }
    ...
    /*     * ************************** */
    /*     * *** Get Individual Cooperative_officers Profile **** */
    /*     * ************************** */
